...
export default class DemoGame extends LightningElement {
    ...
    displayCard(event){
        ...
        currCard.classList.add("show","open","disabled")
        this.openedCards=this.openedCards.concat(event.target)
        console.log("Cards Clicked "+this.openedCards.length)
    ...
    matched(){
        ...
        if(this.matchedCards.length===16){
            ...
            let ele = this.template.querySelectorAll('.cards')
    ...
    unmatched(){
        ...
        this.action('DISABLE')
        setTimeout(()=>{
            this.openedCards[0].classList.remove("show","open","unmatched","disabled")
            this.openedCards[1].classList.remove("show","open","unmatched","disabled")
            this.action('ENABLE')
            this.openedCards=[]
        },1100)
